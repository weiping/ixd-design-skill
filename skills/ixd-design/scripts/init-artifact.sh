...
# ============================================
# Step 5: Create layout components from templates
# Canonical source: scripts/templates/ — edit there, not here
# ============================================
...
# Copy layout components from templates (single source of truth)
cp "$TEMPLATES_DIR/PrototypeShell.tsx" src/components/layout/PrototypeShell.tsx
